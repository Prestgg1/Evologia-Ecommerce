...
const Product = (props) => {
  ...
  return (
    <div className="bg-[#f8f8f8] relative h-full justify-between items-start rounded-3xl gap-4 p-4 md:w-full w-auto flex flex-col">
      <div className="lg:h-[350px] h-[250px] w-full bg-white justify-center items-center rounded-3xl overflow-hidden flex "><img src={image} className="duration-300 hover:scale-[0.6] scale-50 object-cover" alt="" /></div>
